...
class LinkDatumCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RequestDatumCreateNestedManyWithoutLinkDataInput,
  })
  @ValidateNested()
  @Type(() => RequestDatumCreateNestedManyWithoutLinkDataInput)
  @IsOptional()
  @Field(() => RequestDatumCreateNestedManyWithoutLinkDataInput, {
    nullable: true,
  })
