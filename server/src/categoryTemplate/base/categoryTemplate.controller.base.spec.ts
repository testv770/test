...
describe("CategoryTemplate", () => {
  ...
  test("POST /categoryTemplates", async () => {
  ...
  test("GET /categoryTemplates", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /categoryTemplates/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/categoryTemplates"}/${nonExistingId}`)
  ...
  test("GET /categoryTemplates/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/categoryTemplates"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
